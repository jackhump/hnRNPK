...
write_tsv(di_res %>% arrange(pvalue), file = here::here("Tables/motif_res_k2.tsv"))
```
...
write_tsv(tri_res %>% arrange(pvalue), file = here::here("Tables/motif_res_k3.tsv"))
```
...
ggsave(plot = quad_volcano, filename = here::here("Buratti/motif_4mer_volcano.pdf"), width = 4, height = 6, )

# write out
write_tsv(quad_res %>% arrange(pvalue), file = here::here("Tables/motif_res_k4.tsv"))
